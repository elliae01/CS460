...
class MyoRaw(object):
    ...
    def connect(self):
        ...
        if self.old:
            ...
            # This defines a specific Myo
            # For testing another armband was used with this address:
            # b'\x00\x03\x00\x00\x06My Myo' or b'\x00\x03\x00\x00\x08Elliae01' or b"\x00\x03\x00\x00\nKyle's Myo'
            if(name.payload == b'\x00\x03\x00\x00\x08Elliae01'):
                
                print('device name: %s' % name.payload)
                
                # short vibrate to inform user that connection has been established.
                self.vibrate(1)
    ...
    def shotFiredLeftArm():
        ...
        if(MyoRaw.emgShotFiredMeasurementLeftArm()==True
               and accelerometer[2]>860 and gyroscope[2]<-220):
