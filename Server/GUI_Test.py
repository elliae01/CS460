...
def guiMain(display_Surface,cursor,clock):
    ...
    scrubber = Slider(display_Surface, "Scrubber", 0, 0, len(data_array)-1, 0, 700)
        ...
        try:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    if scrubber.button_rect.collidepoint(pos):
                        scrubber.hit = True
            ...
            DisplayScrubber(scrubber, sliderPos)
...
def DisplayScrubber(scrubber, sliderPos):
    if scrubber.hit:
        scrubber.move()
    scrubber.draw()
